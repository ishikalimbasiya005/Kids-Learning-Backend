          ...
          <div className="our-books-card">
            <div className="our-book">
              <div className="our-book-img">
                <img loading="lazy"  src="assets/English-book.jpg" alt="English Book" />
              </div>
            ...
            <div className="our-book">
              ...
              />
              <div className="our-book-img">
                <img loading="lazy"  src="assets/Science-book.jpg" alt="Science Book" />
              </div>
              <div className="our-book-content">
                <h3 className="our-book-title">
            ...
            <div className="our-book">
              <div className="our-book-img">
                <img loading="lazy"  src="assets/Math-book.jpg" alt="Math Book" />
              </div>
              <div className="our-book-content">
                <h3 className="our-book-title">
            ...
            <div className="our-book">
              <div className="our-book-img">
                <img loading="lazy"  src="assets/skillBook.jpg" alt="skill-book-card" />
              </div>
              <div className="our-book-content">
                <h3 className="our-book-title">
